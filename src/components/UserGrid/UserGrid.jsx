...
function UserGrid() {
  ...
  if (loading) {
    return <CircularProgress sx={{marginLeft: 'auto', marginRight: 'auto', marginTop: '200px'}} size={100} />;
  }

  return (
    <>
      <Grid container spacing={{xs: 2, sm: 2, md: 2}} columns={{xs: 2, sm: 3, md: 4}} style={{padding: '10px'}}>
